  ...
  return (
    ...
    >
      <div className='-translate-y-[28px]'>
        <div
          data-aos='fade-up'
          className='flex flex-col pt-[60px] xl:pt-[125px] items-center container px-8 xl:px-0'
        >
          <h1 className='text-[38px] xl:text-7xl text-white luckiest font-normal leading-[72px] text-center'>
            Total Supply
          </h1>
          <p className=' text-[12px] xl:text-[26px] w-full xl:w-[75%] paytone text-[#F3D583] font-normal xl:leading-[36.3px] text-center'>
