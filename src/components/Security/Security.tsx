...
export const Security = () => {
  return (
    <section className="w-full h-[1078px] relative ">
      ...
      />
      <div className="container px-8 xl:px-0 flex h-full flex-col justify-end pb-[107px]">
        ...
        <div className="grid gap-x-[61px] grid-cols-1 gap-y-[61px] xl:grid-cols-3">
          <div className="bg-[#F3D583] relative rounded-[21px]  py-[35px] px-[34px]">
            <h1 className="text-2xl font-normal leading-6 text-left luckiest">
              Secure <br /> Transactions
            </h1>
            <p className="text-base paytone mt-[9px] font-normal leading-[27.39px] tracking-[-0.01em] text-left">
