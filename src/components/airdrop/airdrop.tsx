    ...
    <section className="w-full min-h-screen xl:h-[1308px] relative">
      <div className="w-full flex flex-col  xl:flex-row h-full container">
        <div className=" relative w-full pt-20 xl:pt-0 xl:w-1/2 h-full flex flex-col items-center justify-center">
          <div data-aos="flip-up" className="w-full xl:w-[462px] relative">
            ...
            <div className="absolute pl-0 left-1/2 xl:left-[50%] -translate-x-1/2 md:pl-8 xl:pl-0 flex justify-center flex-col items-center  top-[40%] -translate-y-1/2">
              ...
              <p className="text-[10px] xl:text-sm w-[100%] text-[#263D6B] paytone font-normal xl:leading-[19.54px] text-center">
          ...
          <div data-aos="flip-up" className="w-full xl:w-[462px] relative">
            ...
            <div className="absolute pl-0 left-1/2 xl:left-[50%] -translate-x-1/2 md:pl-8 xl:pl-0 flex justify-center flex-col items-center  top-[40%] -translate-y-1/2">
              ...
              <p className="text-[10px] xl:text-sm m-auto w-[100%] text-[#263D6B] paytone font-normal xl:leading-[19.54px] text-center">
        ...
        <div className=" w-full xl:w-1/2 h-full flex items-end">
          <img src="./air-drop-img-1.png" data-aos="fade-left" alt="" />
        </div>
      </div>
      <img
        src="./airdrop-bg.png"
