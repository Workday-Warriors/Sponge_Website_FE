    ...
    <section className='w-full min-h-screen xl:h-[1456px] pt-[160px] relative'>
      <div className='container px-5 xl:px-0'>
        ...
        <div className='grid gap-x-[49px] mt-[100px] gap-y-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-4'>
          <div className='shadow-[0px_11px_8.7px_9px_rgba(255,214,0,0.40)] px-[44px] py-[43px] rounded-[19px] border-4 border-solid border-[#FFC700]'>
          ...
          <div className=' px-[44px] py-[43px] shadow-[0px_11px_8.7px_9px_rgba(220,3,4,0.30)] rounded-[19px] border-4 border-solid border-[#A33737]'>
            <h1 className='text-[#F3D583] mb-[27px] luckiest text-center text-3xl not-italic font-normal leading-[normal]'>
              Peace of Mind:
            </h1>
            <p className='text-white m-auto text-center text-xl paytone not-italic font-normal leading-[35px]'>
          ...
          <div className=' px-[44px] py-[43px] shadow-[0px_11px_8.7px_9px_rgba(7,142,10,0.40)] rounded-[19px] border-4 border-solid border-[#02AE3D]'>
            <h1 className='text-[#F3D583] mb-[27px] luckiest text-center text-3xl not-italic font-normal leading-[normal]'>
              Community Suppor
            </h1>
            <p className='text-white m-auto text-center text-xl paytone not-italic font-normal leading-[35px]'>
